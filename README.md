...
## bs4components
common ui components for web application built on top of bootstrap 4. This templates use mako, not django template.
...
### forms
The code generated by django forms sucks. bs4components provides better html code with bootstrap 4.

import using mako namespace

	<%namespace name="forms" file="/bs4components/forms.html" inheritable="True"/>
